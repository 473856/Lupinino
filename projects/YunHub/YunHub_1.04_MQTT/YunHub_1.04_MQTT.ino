...
// 3) publish to MQTT server 192.168.178.27
//
...
void setup ()
{
    ...
    Serial.begin(57600);
    Serial.println("***");
    Serial.println("*** 150526 YunHub 1.04");
    Serial.println("***");
    Serial.println("***  Log all incoming RF12 data to SD and publish to MQTT server 192.168.178.27");
    Serial.println("***");
...
void loop ()
{
    ...
    if (rf12_recvDone() && rf12_crc == 0)
    {
        ...
        //  Log and publish interpreted date for TNode (group 33, id 22)
